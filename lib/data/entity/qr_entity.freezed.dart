...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String rawJsonData,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QrEntity() when $default != null:
return $default(_that.id,_that.rawJsonData,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String rawJsonData,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _QrEntity():
return $default(_that.id,_that.rawJsonData,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String rawJsonData,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _QrEntity() when $default != null:
return $default(_that.id,_that.rawJsonData,_that.createdAt,_that.updatedAt);case _:
  return null;
