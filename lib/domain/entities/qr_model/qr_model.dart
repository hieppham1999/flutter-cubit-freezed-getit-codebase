...
abstract class QrModel with _$QrModel {
  ...
  factory QrModel({
    ...
    @Default(QrDecoration()) QrDecoration decoration,
  ...
  factory QrModel.copyWithStyle(QrModel model, QrModel styleFrom) {
    ...
    final decorationModel = QrDecoration(
  ...
  factory QrModel.defaultStyle(QrModel model) =>
      QrModel(id: model.id, content: model.content);
